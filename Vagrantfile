...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "jhnftzptrck-tddbook-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/jhnftzptrcktddbook"
  #   chef.validation_client_name = "jhnftzptrcktddbook-validator"
  #   chef.validation_key_path = ".chef/jhnftzptrcktddbook-validator.pem"
  # end
end
